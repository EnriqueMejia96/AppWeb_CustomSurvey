...
import json
from utils import plot_experience, plot_cloud, plot_tools, plot_course, plot_wordcloud_for_goals
...
def main_page():
    ...
    # Assuming 'response.json' is in the same directory as your Streamlit app
